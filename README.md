...
| [Twitch Now](https://addons.mozilla.org/addon/twitch-now/) | Support request was [accepted](https://github.com/Ndragomirov/twitch-now/pull/162), awaiting for release <sup>[[*]](#testing)</sup> | Unknown |
