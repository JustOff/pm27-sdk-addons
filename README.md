...
| [Simple YouTube MP3 Button](https://addons.mozilla.org/addon/simple-youtube-mp3-button/) | Add-on should be forked based on [1.0.2.6](https://addons.mozilla.org/En-us/firefox/addon/simple-youtube-mp3-button/versions/1.0.2.6) <sup>[[*]](#testing)</sup> | Unknown |
